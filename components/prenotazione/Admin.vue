...
const utente = await dipendentiStore.getDipendenteById(props.prenotazione?.id_utente as number)
...
<div style = "scale:0.9; margin-bottom: 5px;">
    ...
    <div class = "modifica"  @click="router.push({ name: 'modifica_prenotazione', query: { option: 0, idDaModificare : props.prenotazione?.id_prenotazione} })">
...
<!------A1------------------------------------------>
        ...
        <div style = "position: absolute; left: 195px; top: 45px;" v-if = "categoria.id_categoria == 'A1'">
            <img src = "../../img/scrivania.png" width="80px">
            
        </div>

        <div style = "scale:0.8;position: absolute; left: 270px; bottom: 20px; flex-direction: column; 
...
<div style = "position: absolute; left: 185px; top: 53px;" v-if = "categoria.id_categoria == 'A2'">
            <img src = "../../img/scrivania_con_monitor.png" width="60px">
            
        </div>

        <div style = "scale:0.8;position: absolute; left: 240px; bottom: 20px; flex-direction: column; 
        display: flex; font-weight: 700; line-height: 0.8; font-size: 18px;"
...
<div style = "position: absolute; left: 185px; top: 40px;" v-if = "categoria.id_categoria == 'B'">
            <img src = "../../img/sala_riunioni.png" width="60px" style = "margin-top: 12px">
            
        </div>

        <div style = "scale:0.8;position: absolute; left: 250px; bottom: 20px; flex-direction: column; 
        display: flex; font-weight: 700; line-height: 0.8; font-size: 18px;"
...
<div style = "position: absolute; left: 185px; top: 45px;" v-if = "categoria.id_categoria == 'C'">
